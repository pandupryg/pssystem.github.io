...
<body style="background-color:white">
  <?php
  use App\Brand;
  $brandheader = Brand::all();
?>

<div class="container">
    <!-- Navbar -->
    <nav class="navbar navbar-expand-lg" style="background-color: white">
        <a class="navbar-brand" href="/home"><img src="{{ asset('upload/PS.png') }}" height="65px" width="140px"></a>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
          <ul class="navbar-nav">
            <li class="nav-item dropdown">
              ...
              {{-- Dropdown menu category role manager --}}
              @if (auth()->user()->role=="manager")
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                  @foreach ($brandheader as $brh)
                      <a class="dropdown-item" href="/phones/{{$brh->id}}">{{$brh->brand_name}}</a>
                  @endforeach

              </div>
              @else
              {{-- Dropdown menu category role user --}}
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                  @foreach ($brandheader as $brh)
                      <a class="dropdown-item" href="/phones/{{$brh->id}}">{{$brh->brand_name}}</a>
                  @endforeach
            ...
            <li class="nav-item dropdown">
              ...
              {{-- dropdown untuk role manager --}}
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                  <a class="dropdown-item" href="/addPhone">Add Phone</a>
                  <a class="dropdown-item" href="/addDetailPhone">Add Phone Detail</a>
                  <a class="dropdown-item" href="/addNewBrand">Add New Brand</a>
                  <a class="dropdown-item" href="/manageBrand">Manage Brands</a>
                  <a class="dropdown-item" href="/addArticle">Add New Article</a>
              ...
              {{-- dropdown untuk role user --}}
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                  <a class="dropdown-item" href="{{ route('my-cart') }}">My Cart</a>
...
<footer id="footer" class="footer-1">
  ...
  <div class="col-xs-12 col-sm-6 col-md-3">
    <div class="widget subscribe no-box">
      <h5 class="widget-title">PS SYSTEM<span></span></h5>
      <h6>Sistem yang bertujuan untuk memudahkan pemilik melakukan pencatatan data  seperti stok barang, jenis barang, dll. Akan ada beberapa menu misalnya menu laporan isinya grafik grafik,
        menu penjualan isinya list item barang, harga, stok dan ada tombol buat cetak struk, dll.</h6>
    </div>
  </div>
  ...
  <div class="col-xs-12 col-sm-6 col-md-3">
    ...
    <h5 class="widget-title">Quick Links<span></span></h5>
      <ul class="thumbnail-widget">
        <li>
          <div class="thumb-content"><a href="/home">Get Started</a></div>
        </li>
        <li>
          <div class="thumb-content"><a href="#brands">Brands</a></div>
        </li>
        <li>
          <div class="thumb-content"><a href="/listArticle">Article</a></div>
        </li>
        <li>
          <div class="thumb-content"><a href="#footer">About</a></div>
        </li>
      </ul>
    </div>
  </div>
  ...
  <div class="col-xs-12 col-sm-6 col-md-3">
    <div class="widget no-box ml-2">
      <h5 class="widget-title">Metode Pembayaran<span></span></h5>
      <img src="https://eraspace.com/pub/media/wysiwyg/footer/All_Payment_Method_2_November_2020_2_.png" alt="" width="300rem">

    </div>
  </div>

  <div class="col-xs-12 col-sm-6 col-md-3">
    <div class="widget no-box ml-5">
      <h5 class="widget-title">Contact Us<span></span></h5>

      <p><a href="mailto:psSystem20@gmail.com" title="glorythemes" style="color: white">psSystem20@gmail.com</a></p>
    ...
    <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            <p class="text-sm-center">Copyright PSSYSTEM.COM © 2021. All rights reserved.</p>
          </div>
        </div>
    </div>
  </div>
