...
<div class="container" data-aos="zoom-in">
  ...
  <div class="row d-flex align-items-center">
      ...
      <div class="col-lg-2 col-md-4 col-6">
        <a href="/phones/{{$br->id}}"><img src="{{ asset('upload/phone/' . $br->photo) }}" class="img-fluid" alt=""></a>
      </div>
      @endforeach
  </div>
...
<div class="container">
  ...
  {{-- <h2 class="text-left">Welcome to PS System : {{Auth::user()->username ?? ''}}</h2> --}}
  ...
  <div class="container">
    <div class="">
      ...
      <div class="row">
        ...
        <a href="/phones/{{$br->id}}" class="mt-1">LIHAT SEMUA >></a>
      </div>
            ...
            @foreach ($phone as $ph)
              ...
              <div class="card mt-2 mb-5 mr-3" style="width: 11rem;">
                ...
                <div class="overlay-btn p-1">
                  <a href="/phoneDetail/{{ $ph->id }}" class="btn m-auto"><i class="icon-eye-open"></i> Quick View</a>
...
<section id="article-us" class="article-us">
  <div class="container">
    <div class="row">
      ...
      <a href="/listArticle" class="mt-2">LIHAT SEMUA >></a>
    ...
    <div class="row mr-5">
      ...
      <div class="col-md-5" data-aos="fade-up">
          <div class="box" >
            <a href="/articleDetail/{{ $ar->id }}"><img src="{{ asset('upload/phone/'. $ar->photo) }}" style="width: 20rem"></a>
